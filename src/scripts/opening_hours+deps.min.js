...
(function (global, factory) {
  ...
  var data$a = { PH:[ { name:"uudenvuodenpäivä - nyårsdagen",
        fixed_date:[ 1,
          1 ] },
  ...
  var data$b = { PH:[ { name:"Jour de l'an",
        fixed_date:[ 1,
          1 ] },
      { name:"Vendredi saint",
        variable_date:"easter",
  ...
  var data$c = { England:{ PH:[ { name:"New Year’s Day",
          fixed_date:[ 1,
            1 ] },
        { name:"Good Friday",
          variable_date:"easter",
  ...
  var data$d = { PH:[ { name:"Πρωτοχρονιά",
        fixed_date:[ 1,
          1 ] },
      { name:"Θεοφάνια",
        fixed_date:[ 1,
  ...
  var data$f = { PH:[ { name:"New Year’s Day",
        fixed_date:[ 1,
          1 ] },
  ...
  var data$h = { PH:[ { name:"Nieuwjaarsdag",
        fixed_date:[ 1,
          1 ] },
      { name:"Goede vrijdag",
        variable_date:"easter",
  ...
  var data$l = { PH:[ { name:"1. Новогодние каникулы",
        fixed_date:[ 1,
          1 ] },
  ...
  var data$o = { PH:[ { name:"Deň vzniku Slovenskej republiky",
        fixed_date:[ 1,
          1 ] },
      { name:"Zjavenie Pána",
        fixed_date:[ 1,
  ...
  var data$q = { PH:[ { name:"New Year's Day",
        fixed_date:[ 1,
          1 ] },
      { name:"Memorial Day",
        variable_date:"lastMayMonday" },
  ...
  var data$s = { "assuming ok for ko":{ daytime:"sunrise-sunset",
      spring:"Mar-May",
      summer:"Jun-Aug",
      autumn:"Sep-Nov",
      winter:"Dec-Feb",
  ...
  var data$t = { "unexpected token":"Unexpected token: \"__token__\" This means that the syntax is not valid at that point or it is currently not supported.",
  ...
  */
  ...
  var data$u = { en:{ opening_hours:{ pretty:{ off:"closed",
          SH:"school holidays",
          PH:"public holidays" } } },
  ...
  if (!i18next.isInitialized()) {
      ...
      for (var lang in data$u) {
          i18next.addResourceBundle(lang, 'opening_hours', data$u[lang]['opening_hours'], true);
  ...
  function index(value, nominatim_object, optional_conf_parm) {
      ...
      function returnCorrectWordOrToken(word, value_length) {
          ...
          Object.keys(data$s).forEach(function (comment) {
              if (correctWordOrToken) {
                  return;
              }
              Object.keys(data$s[comment]).forEach(function (old_val) {
                  if (correctWordOrToken) {
                      return;
                  }
                  if (new RegExp('^' + old_val + '$').test(word)) {
                      var val = data$s[comment][old_val];
